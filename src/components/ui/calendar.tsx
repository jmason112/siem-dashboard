  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        nav_button: cn(
          "h-7 w-7 bg-transparent p-0 opacity-50 hover:opacity-100 dark:text-gray-100 dark:hover:text-gray-50"
        ),
        ...
        day: cn(
          "h-9 w-9 p-0 font-normal aria-selected:opacity-100 hover:bg-accent hover:text-accent-foreground dark:hover:bg-gray-700"
        ),
        ...
        day_today:
          "bg-accent text-accent-foreground dark:bg-gray-700 dark:text-gray-100",
        day_outside:
